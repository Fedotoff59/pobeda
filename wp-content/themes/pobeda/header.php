...
<body>
	...
	<div id="wrapper">
	<img src="<?php bloginfo('template_url'); ?>/images/back-left-02.png" style=" float:left; height: 100%; top:0;left:0; bottom:0; right:0; position: fixed; z-index: -1;">
<img src="<?php bloginfo('template_url'); ?>/images/back-right-02.png" style=" float:right; height: 100%;  bottom:0; right:0; position:fixed; z-index: -1;">
		<div id="header">
			<div class="menu">
				<ul>
			...
			<div class="menu">
				<ul>
					<li><a href="http://pobeda.dobrovoblago.ru/anketa-volontera/"><span>РЕГИСТРАЦИЯ</span></a></li>
					<li><a href="http://pobeda.dobrovoblago.ru/news/"><span>НОВОСТИ</span></a></li>
